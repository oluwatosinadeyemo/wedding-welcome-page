-- Fix generate_pass_by_guest_id: remove reference to pass_generated_at which
-- does not exist in the live guests table (was omitted by an earlier migration).
-- Only pass_id needs to be written; the column is not needed for the feature.
