  ...
  const hotelGroups = [
    ...
    },
    {
      ...
      hotels: [
        ...
        {
          name: "AA Entertainment & Tourism Hotel",
          distance: "25 mins to venue",
          description: "Premier luxury hotel with world-class amenities and conference facilities (formerly Park Inn by Radisson)",
          phone: "+234 813 986 0020",
          website: "https://www.tripadvisor.com/Hotel_Review-g1760497-d8788118-Reviews-Aa_Entertainment_Hotel_Abeokuta-Abeokuta_Ogun_State.html",
          price: "₦111,540",
          rating: 5,
        },
        {
