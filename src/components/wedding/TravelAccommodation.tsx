...
const TravelAccommodation = () => {
  const hotels = [
    ...
    {
      name: "Caesar's Court Hotel and Suites",
      distance: "4 km from venue",
      description: "Top-rated boutique luxury option with personalized service",
    ...
    {
      name: "Modroy Hotel and Suites",
      distance: "3 km from venue",
      description: "Modern establishment with premium dining and event spaces",
    ...
    {
      name: "Jimson International Hotel",
      distance: "6 km from venue",
      description: "Established choice for international travelers with full amenities",
    ...
    },
    {
      ...
      distance: "4 km from venue",
      description: "Beautiful blend of traditional and modern luxury",
    ...
    },
    {
      ...
      description: "Central location with quality service and comfortable rooms",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="animate-fade-in-up">
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            <h3 className="font-serif text-3xl text-foreground">Top 10 Hotels</h3>
            <Hotel className="w-6 h-6 text-primary" />
